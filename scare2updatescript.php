<html>
    ...
    <head>
        ...
        <title>THOD Scare Camera 2</title>

        <!--Link the HTML5 Document to the CSS file styling it.-->
        <link rel = "stylesheet" href = "css/scare2css.css"></link rel>
    ...
    <body>
        ...
        <h3>Scare Camera 2</h3>

        <!--Fetch The Video Feed From The RTSP Server.-->
        <iframe width="640" height="480" src="https://rtsp.me/embed/2tRaYZAr/" frameborder="0" allowfullscreen></iframe>
    ...
    <script src="script/scare2javascript.js"></script>
...
$username = "thehou38_arduino2";		// Database username
$password = "S3T0FfSc@r32!";	        // Database password
...
if (isset($_POST['update'])){
    $sql = "UPDATE PropStatus SET Trigger_Status='1' WHERE Prop_Name='HeadDoll'"; 
...
if (isset($_POST['downdate'])){
    $sql = "UPDATE PropStatus SET Trigger_Status='0' WHERE Prop_Name='HeadDoll'"; 
